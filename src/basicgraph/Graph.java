...
//		Graph graphFromFile = new GraphAdjList();
		...
		System.out.println("********\n My tests. Graph data for Lviv roads.");
		GraphAdjList lvivRoardsGraph = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/lviv.map", lvivRoardsGraph);
		System.out.println(lvivRoardsGraph);
		System.out.println(lvivRoardsGraph.getNeighbors(1));
		System.out.println(lvivRoardsGraph.getNeighbors(832));
		System.out.println(lvivRoardsGraph.getNeighbors(1681));
		System.out.println(lvivRoardsGraph.getNeighbors(994));
		System.out.println(lvivRoardsGraph.getDistance2(1));
