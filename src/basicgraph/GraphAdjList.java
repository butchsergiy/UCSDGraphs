...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> verticesIn1Hop = new ArrayList<>();
		 List<Integer> verticesIn2Hops = new ArrayList<>();
		 verticesIn1Hop = adjListsMap.get(v);
		 for (Integer neighbor : verticesIn1Hop) {
			 verticesIn2Hops.addAll(adjListsMap.get(neighbor));
		 }
		 Collections.sort(verticesIn2Hops);
