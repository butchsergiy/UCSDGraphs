...
public class Maze {
	...
	public List<MazeNode> dfs(int startRow, int startCol, int endRow, int endCol) {
		...
		boolean found = doSearch(start, goal, parentMap);
		...
		LinkedList<MazeNode> path = getPath(start, goal, parentMap);
		return path;
	}
	...
	private boolean doSearch(MazeNode start, MazeNode goal, HashMap<MazeNode, MazeNode> parentMap) {
